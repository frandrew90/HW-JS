...
// Функция dirtyMultiply(array, value) умножает каждый элемент массива array на число value.Она изменяет(мутирует)
// исходный массив по ссылке.

// Чистая функция(pure function) - это функция результат которой зависит только от значений переданных аргументов.
// При одинаковых аргументах она всегда возвращает один и тот же результат и не имеет побочных эффектов, то есть не
// изменяет значения аргументов.
...
//       element % 2 === 0 ?
//         number.push(element + value) : number.push(element);
//       });
//   return number;
//     // Пиши код выше этой строки
//   }
...
// Метод map()
// Большинство перебирающих методов массива это чистые функции.Они создают новый массив, заполняют его, применяя
// к значению каждого элемента указанную коллбек - функцию, после чего возвращают этот новый массив.

// Метод map(callback) используется для трансформации массива.Он вызывает коллбек - функцию для каждого элемента
// исходного массива, а результат её работы записывает в новый массив, который и будет результатом выполнения метода.
...
//  const filtredUsers = users.filter(user => user.eyeColor === color);
//   return filtredUsers;
...
//  const filtredUsers = users.filter(user => user.age > minAge && user.age < maxAge);
...
//   const filtredUser = users.filter((user) => user.friends.includes(friendName));
//   return filtredUser;
// };
// // Пиши код выше этой строки
// const frends = getUsersWithFriend(array1, "Briana Decker");
// console.log(frends);
...
//   const filtredFriends = allFriends.filter(
...
// // Пиши код ниже этой строки
// debugger;
// const totalPlayTime = playtimes.reduce((totalTime, user) => {
...
// // Пиши код ниже этой строки
// const calculateTotalBalance = users => users.reduce((sum, elem) => sum += elem.balance, 0);
// // Пиши код выше этой строки
...
// // Пиши код ниже этой строки
// const getTotalFriendCount = users => users.reduce((sum, elem) => sum += elem.friends.length , 0);
// // Пиши код выше этой строки
...
// // Пиши код ниже этой строки
// const getTotalBalanceByGender = (users, gender) => users.filter(user => user.gender === gender).reduce((sum, elem) => sum += elem.balance,0);
// // Пиши код выше этой строки
